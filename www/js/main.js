...
function initNav(){
  ...
  ["rateModal","detailModal","editModal","friendModal","genreModal","swipeSettings","confirmModal","yearSheet","duelSheet","inviteSheet","shareSheet","fpSheet","lookSheet"].forEach(id=>{
...
initNav();initSearch();initProfile();if(typeof initCompatUI==="function")initCompatUI();if(typeof initLook==="function")initLook();if(!_authTook)initOnboard();initCoach();initBrowse();
